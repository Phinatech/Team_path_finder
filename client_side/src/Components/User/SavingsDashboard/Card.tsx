  ...
  return (
    <Container>
      <NavLink to="/usersavings" style={{textDecoration: "none"}}>
        <Card1>
        <Img src={img1} />
        <Bold><p>Savings</p></Bold>
        <P><p>Strict savings automatically. Daily, weekly or Monthly. 10% p.a</p></P>
        <Bold><p>₦0.00</p></Bold>
      </Card1>
      </NavLink>
      ...
      <NavLink to="/userbacktoschool" style={{textDecoration: "none"}}>
        <Card2>
        <Img src={img2} />
        <Bold2><p>Back To School</p></Bold2>
        <P><p>Flexible savings for emergencies. Free transfers, withdrawals etc. 8% p.a</p></P>
        <Bold2><p>₦0.00</p></Bold2>
      </Card2>
      </NavLink>
      ...
      <NavLink to="/savings/safelock" style={{textDecoration: "none"}}>
        <Card3>
        <Img src={img3} />
        <Bold3><p>Safelock</p></Bold3>
        <P><p>Lock funds to avoid temptations. Upfront interest. Up to 13% p.a</p></P>
        <Bold3><p>₦0.00</p></Bold3>
      </Card3>
      </NavLink>
      ...
      <NavLink to="/savings/target" style={{textDecoration: "none"}}>
        <Card4>
        <Img src={img4} />
        <Bold4><p>Targets</p></Bold4>
        <P><p>Reach your unique individual saving goals. 9% p.a</p></P>
        <Bold4><p>₦0.00</p></Bold4>
      </Card4>
      </NavLink>

      <Card5>
        <Img src={img5} />
        <Bold5><p>Flex Dollar</p></Bold5>
        <P><p>Save & grow your wealth in dollars. Up to 7% p.a in dollars</p></P>
        <Bold5><p>₦0.00</p></Bold5>
      </Card5>

      <Card6>
        <Img src={img6} />
        <Bold6><p>PocketApp®</p></Bold6>
        <P><p>Withdraw your savings to your pocket faster ⚡️</p></P>
        <Bold6><p>Connect Account</p></Bold6>
      </Card6>
    </Container>
  )
}
